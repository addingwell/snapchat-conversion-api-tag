...
function getClickId() {
  return parseUrl(eventData.page_location).searchParams.ScCid || getCookieValues('_scclid')[0] || getCookieValues('FPSCCLID')[0] || eventData._scclid || eventData.scclid;
}

function getBrowserId() {
  return getCookieValues('_scid')[0] || getCookieValues('FPSCID')[0] || eventData.scid || eventData._scid || generateUUID();
}
